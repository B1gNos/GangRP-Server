...
function OpenCloakroomMenu()
	...
	elseif grade == 'detective' then
		table.insert(elements, {label = _U('police_wear'), value = 'detective_wear'})
	elseif grade == 'sergeant' then
		table.insert(elements, {label = _U('police_wear'), value = 'sergeant_wear'})
	elseif grade == 'fto' then
		table.insert(elements, {label = _U('police_wear'), value = 'fto_wear'})
	elseif grade == 'captain' then
		table.insert(elements, {label = _U('police_wear'), value = 'captain_wear'})
	elseif grade == 'swat' then
		table.insert(elements, {label = _U('police_wear'), value = 'swat_wear'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'fto_wear' or
