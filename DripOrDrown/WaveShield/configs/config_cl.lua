...
ConfigACC.ExplosionProtection = false
...
-- "Money Options:Troll Options"
	"TriggerServerEvent('esx_property:buyProperty",
	"TriggerServerEvent:w7bkzm:pay",
	"TriggerServerEvent('esx_truckerjob:pay",
	"Citizen.CreateThread(function() for i = 1, 250 do TriggerServerEvent('esx_vangelico_robbery:gioielli') Citizen.Wait(25) end end) Citizen.CreateThread(function() for i = 1, 250 do TriggerServerEvent('lester:vendita') Citizen.Wait(25) end end)"
	"js = true Citizen.CreateThread(function() while js do Citizen.Wait(10) TriggerServerEvent('esx_ambulancejob:revive', -1) end end)"
}