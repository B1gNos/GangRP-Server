...
Config.RespawnPoint = { coords = vector3(-11.05, -1829.02, 25.39), heading = 48.5 }
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Vehicles = {
			{
				Spawner = vector3(292.91, -610.55, 43.37),
				InsideShop = vector3(286.42, -604.07, 43.19),
				Marker = { type = 36, x = 1.0, y = 1.0, z = 1.0, r = 100, g = 50, b = 200, a = 100, rotate = true },
				SpawnPoints = {
					{ coords = vector3(294.13, -605.43, 43.32), heading = 71.13, radius = 4.0 },
				}
			}
		},
