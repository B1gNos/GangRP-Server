...
Config.WeaponClipAmmo = 250 -- Will give this many buillets to player

-- Vehicle GPS
Config.UseVehicleGPS = false -- Set to true to use Vehicle GPS.
Config.LimitedVehicles = false -- Set to true to only allow Aircrafts, Boats, & Cars to use GPS.
Config.OnlyFrontSeats = false -- Set to true to only allow the front 2 seats to be able to see Radar if they used it.
