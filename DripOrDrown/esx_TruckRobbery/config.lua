...
Config.MissionCost = 25000		-- taken from bank account // set to 0 to disable mission cost

-- Reward Settings:
Config.MinReward = 50000						-- set minimum reward amount
Config.MaxReward = 100000						-- set maximum reward amount
